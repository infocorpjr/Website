...
var contact = new Vue({
    ...
    methods: {
        submitForm: function submitForm() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://lumen.infocorp.local/api/contato', this.form).then(function (response) {
                _this.form.successful = "Enviado com sucesso!";
            }).catch(function (error) {
                console.log(error.response.data);

                _this.form.errors = _this.errorListServer(error);
            });
        },
        ...
        errorListServer: function errorListServer(error) {
            var log = {};
 ...
 * https://modernizr.com/download/?-cssanimations-cssgrid_cssgridlegacy-flexbox-flexboxlegacy-flexwrap-setclasses !*/
!function (e, n, t) {
  function r(e, n) {
    return (typeof e === "undefined" ? "undefined" : _typeof(e)) === n;
  }function s() {
    var e, n, t, s, o, i, a;for (var l in x) {
    ...
    }for (var d, c, p, m, y, v = ["modernizr", "tspan", "samp"]; !E.style && v.length;) {
      d = !0, E.modElem = a(v.shift()), E.style = E.modElem.style;
    }for (p = e.length, c = 0; p > c; c++) {
      if (m = e[c], y = E.style[m], i(m, "-") && (m = l(m)), E.style[m] !== t) {
    ...
    var i = e.charAt(0).toUpperCase() + e.slice(1),
        a = (e + " " + T.join(i + " ") + i).split(" ");return r(n, "string") || r(n, "undefined") ? y(a, n, s, o) : (a = (e + " " + P.join(i + " ") + i).split(" "), u(a, n, t));
  }function h(e, n, r) {
    return v(e, t, t, n, r);
  }var C = [],
      x = [],
      ...
      b = "Moz O ms Webkit",
      T = w._config.usePrefixes ? b.split(" ") : [];w._cssomPrefixes = T;var P = w._config.usePrefixes ? b.toLowerCase().split(" ") : [];w._domPrefixes = P;var z = { elem: a("modernizr") };Modernizr._q.push(function () {
    delete z.elem;
  });var E = { style: z.elem.style };Modernizr._q.unshift(function () {
    delete E.style;
  }), w.testAllProps = v, w.testAllProps = h, Modernizr.addTest("cssanimations", h("animationName", "a", !0)), Modernizr.addTest("cssgridlegacy", h("grid-columns", "10px", !0)), Modernizr.addTest("cssgrid", h("grid-template-rows", "none", !0)), Modernizr.addTest("flexbox", h("flexBasis", "1px", !0)), Modernizr.addTest("flexboxlegacy", h("boxDirection", "reverse", !0)), Modernizr.addTest("flexwrap", h("flexWrap", "wrap", !0)), s(), o(C), delete w.addTest, delete w.addAsyncTest;for (var N = 0; N < Modernizr._q.length; N++) {
    Modernizr._q[N]();
